...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n  query ALL_TODOS_QUERY($task: String, $id: ID, $skip: Int = 0, $first: Int = ", ") {\n    todoes(task: $task, id: $id, orderBy: createdAt_DESC, skip: 0) {\n      id\n      task\n    }\n  }\n"]);
...
var TodosList = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div(_templateObject()); // Query all Todos from prisma, and map Todo components
...
//# sourceMappingURL=index.js.2b6406b3b112d4978175.hot-update.js.map