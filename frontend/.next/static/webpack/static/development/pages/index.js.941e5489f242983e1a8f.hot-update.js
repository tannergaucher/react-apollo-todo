...
function update() {
  console.log('manually update cache so client matches server'); //1. read the cache for the items we want (re-use query from items page)
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(rebass__WEBPACK_IMPORTED_MODULE_4__["Button"], {
      ...
      onClick: function onClick() {
        if (confirm("Are you sure you want to delete this Todo")) {
          // console.log('delete props.id', props.id)
...
//# sourceMappingURL=index.js.941e5489f242983e1a8f.hot-update.js.map